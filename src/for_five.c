...
/*   Updated: 2025/02/06 12:11:23 by pjurdana         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_bestmove_for_five(t_stack **stack_a, t_stack **stack_b, int size)
{
	while (size > 3)
	{
		if ((*stack_a)->nbr == ft_find_max(*stack_a)
			|| (*stack_a)->nbr == ft_find_max(*stack_a))
		{
			push_b(stack_a, stack_b);
			size--;
		}
		else if (ft_stacklast(*stack_a)->nbr == ft_find_max(*stack_a)
			|| ft_stacklast(*stack_a)->nbr == ft_find_min(*stack_a))
		{
...
void	ft_for_five(t_stack	**stack_a, t_stack **stack_b)
{
	...
	while (size > 0)
	{
		if ((*stack_b)->nbr == ft_find_max(*stack_b)
			&& (*stack_b)->nbr > ft_find_max(*stack_b))
		{
